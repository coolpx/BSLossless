...
1. Open the game folder: select your instance in BSManager then press the gear in the top right and select "Open folder"
2. Navigate to the maps folder: "Beat Saber_Data" > "CustomLevels"
3. In any map's folder, add an audio file named "override".
	> Supported extensions: flac, wav, aiff, aif, ogg, mp3, wma

That's it! The mod will automatically detect the audio override and play it instead of the egg/ogg in-game.
